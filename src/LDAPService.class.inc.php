...
class LDAPService
{
	 ...
	 * @return bool
	 */
	public function ldap_set_option($ldap, int $option,	$value): bool
    {
	 ...
	 * @return false|resource
	 */
	public function ldap_read($ldap, $base, $filter, array $attributes = [])
    {
	 ...
	 * @return array|false
	 */
	public function ldap_get_entries($ldap, $result)
    {
	 ...
	 * @return array|false
	 */
	public function ldap_count_entries($ldap, $result)
    {
		return @ldap_count_entries($ldap, $result);
	}

	public function ldap_parse_result($ldap, $result, &$error_code, &$matched_dn, &$error_message, &$referrals, &$controls = null): bool
    {
